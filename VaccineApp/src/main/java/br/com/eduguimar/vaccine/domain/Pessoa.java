package br.com.eduguimar.vaccine.domain;
...
public class Pessoa {
	...
	private GrupoPrioritario grupo;
	...
	public GrupoPrioritario getGrupoPrioritario() {
		return grupo;
	}
	public void setGrupoPrioritario(GrupoPrioritario grupo) {
		this.grupo = grupo;
	}
	...
	public int hashCode() {
		...
		result = prime * result + (isVacinada ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (idade == null) {
			...
			return false;
		if (isVacinada != other.isVacinada)
			return false;
		if (nome == null) {
			if (other.nome != null)
				return false;
